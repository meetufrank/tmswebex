...
//        }
    ...
    public function postLogin(){
          $webexid= trim(input('post.webExId'));
            ...
            $result= httpRequest($this->apidomain.'/api/5b432334b00c9', 'post', $postdata,$header,false);
    ...
    public function  webex_list($type=1){
        ...
        $result= httpRequest($this->apidomain.'/api/5b47103ab2ae5', 'post', $postdata,$header,false);
    ...
    public function  webex_content(){
        ...
        if($meetingKey){
            ...
            $result= httpRequest($this->apidomain.'/api/5b4d716111a59', 'post', $postdata,$header,false);
    ...
    public function delete() {
        if(request()->isPost()){
            ...
            $result= httpRequest($this->apidomain.'/api/5b4edb4f60ff3', 'post', $postdata,$header,false);
    ...
    public function webex_add() {
        ...
        if(request()->isPost()){
            ...
            $result= httpRequest($this->apidomain.'/api/5b1a190c62cb9', 'post', $postdata,$header,false);
