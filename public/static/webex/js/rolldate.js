        ...
        value: function baseData() {
            ...
            return {
                ...
                opts: { //插件默认配置
                    ...
                    beginMin: 0,
                    endMin: 59,
                    selectHour:new window.Date().getHours(),
                    selectMin:new window.Date().getMinutes(),
                    theme: '',
                    scrollTime: 200,
                    tapBefore: null,
                    moveEnd: null,
        ...
        value: function createUi() {
            ...
            for (var i = 0; i < len; i++) {
                ...
                if (i == 0 && index < 6) {
                    ...
                    for (var k = _this.config.beginMonth; k <= _this.config.endMonth; k++) {
                    ...
                    for (var m = _this.config.beginHours; m <= _this.config.endHours; m++) {
                        ul += '<li' + (m == _this.config.selectHour ? ' class="active"' : '') + '>' + (m < 10 ? '0' + m : m) + '时</li>';
                    }
                } else if (i == 4 || index > 7 && i == 1) {
                    for (var n = _this.config.beginMin; n <= _this.config.endMin; n += _this.config.minStep) {
                        ul += '<li' + (n == _this.config.selectMin ? ' class="active"' : '') + '>' + (n < 10 ? '0' + n : n) + '分</li>';
                    }
