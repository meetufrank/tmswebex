<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:75:"/www/web/apics/public_html/public/../application/wiki/view/index/login.html";i:1525774918;}*/ ?>
...
<div class="ui middle aligned center aligned grid">
    <div class="column">
        <h2 class="ui teal image header">
            <div class="content">
                欢迎使用<?php echo config('apiAdmin.APP_NAME'); ?>在线文档
            </div>
        </h2>
