<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:70:"D:\www\apiadmin\public/../application/wiki\view\index\calculation.html";i:1525774918;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
    <title><?php echo config('apiAdmin.APP_NAME'); ?> - 算法说明</title>
...
<div class="ui text container" style="max-width: none !important;">
    <div class="ui floating message">
        <h1 class="ui header"><?php echo config('apiAdmin.APP_NAME'); ?> - 算法说明 </h1>
